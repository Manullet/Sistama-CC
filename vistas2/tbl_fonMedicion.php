<?php 
session_start();
 $_SESSION['url'] = 'vistas2/tbl_fonMedicion.php';
...
<div class="containertable">
    <div class="d-flex justify-content-between align-items-end mb-4">
        <div>
            <h1 class="poppins-font mb-2">FON MEDICION</h1>
            <br>
...
<table class="table table-hover">
    <thead class="table-dark text-center" style="background-color: #343A40;">
        ...
        <th scope="col">Cantidad de nitrógeno del estiércol gestionado para Ganado T  D</th>
        <th scope="col">Cantidad de nitrógeno del estiércol gestionado para Ganado T  E</th>
        <th scope="col">Cantidad de nitrógeno de las camas F</th>
        <th scope="col">Cantidad anual de de estiércol animal</th>
        ...
        while ($datos = $sql->fetch_object()) { ?>
            <tr>
                ...
                <td>
                    ...
                    <form id="deleteForm" method="POST" action="modelos3/delete_FONMedicion.php" style="display: inline;">
...
<div class="modal fade" id="modalEditar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        ...
        <h5 class="modal-title">EDITAR FON MEDICION</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
      <form id="formularioEditar" method="POST" action="modelos3/update_FONMedicion.php">
...
<script>
    $(document).ready(function() {
        $("#formularioEditar").on("submit", function(event) {
            ...
            $.ajax({
                url: "modelos3/update_FONMedicion.php",
                method: "POST",
                data: $(this).serialize(),
