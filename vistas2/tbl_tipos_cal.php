<?php 
session_start();
 $_SESSION['url'] = 'vistas2/tbl_tipos_cal.php';
...
<div class="containertable">
    <div class="d-flex justify-content-between align-items-end mb-4">
        <div>
            <h1 class="poppins-font mb-2">Tipo Cal</h1>
            <br>
    ...
    <div class="table-responsive">
        ...
        <table class="table table-hover">
            <thead class="table-dark text-center" style="background-color: #343A40;">
                <tr>
                <th scope="col">Id Tipo Cal</th>
                    <th scope="col">Tipo de Cal</th>
            ...
            <tbody class="text-center">
                ...
                $sql = $conexion->query("SELECT tbl_tipos_cal_n.id_tipo_cal, tbl_tipos_cal_n.tipo_cal, tbl_sector.sector, tbl_tipos_cal_n.descripcion, tbl_tipos_cal_n.modificado_por, tbl_tipos_cal_n.estado 
                FROM tbl_tipos_cal_n INNER JOIN tbl_sector ON tbl_tipos_cal_n.id_sector = tbl_sector.id_sector");
                while ($datos = $sql->fetch_object()) { ?>
                    <tr>
                        <td><?= $datos->id_tipo_cal?></td>
                        ...
                        <td>
                            ...
                            ('<?= $datos->id_tipo_cal ?>', '<?= $datos->tipo_cal?>', '<?= $datos->sector?>', '<?= $datos->descripcion?>', '<?= $datos->modificado_por?>', '<?= $datos->estado?>')">
                                <i class="bi bi-pencil-square"></i>
                                Editar
                            </button>
                            <form id="deleteForm" method="POST" action="modelos2/delete_tipos_cal.php" style="display: inline;">
                                <input type="hidden" name="id_tipo_cal" value="<?= $datos->id_tipo_cal ?>">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="formularioEditar" method="POST" action="modelos2/update_tipos_cal.php">
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                <label for="id_tipo_cal">Id Tipo de Cal</label>
                                <input type="text" class="form-control" id="id_tipo_cal" name="id_tipo_cal" readonly>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                <label for="tipo_cal">Tipo de Cal </label>
                                <input type="text" class="form-control" id="tipo_cal_edit" name="tipo_cal" required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
...
<div class="modal fade" id="modalForm" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content" role="document">
            ...
            <div class="modal-body">
                <form action="modelos2/insert_tipos_cal.php" method="POST">
                    <div class="row mb-3">
                        <div class="row">
                            <label for="tipo_cal" class="form-label">Tipo de Cal</label>
                            <input type="text" class="form-control" id="tipo_cal" name="tipo_cal" required>
                        </div>
...
<script>
    ...
    function abrirModalEditar(id_tipo_cal, tipo_cal, id_sector, descripcion, modificado_por, estado) {
        document.getElementById("id_tipo_cal").value = id_tipo_cal;
        document.getElementById("tipo_cal_edit").value = tipo_cal;
...
<script>
    $(document).ready(function() {
        $("#formularioEditar").on("submit", function(event) {
            ...
            $.ajax({
                url: "modelos2/update_tipos_cal.php",
                method: "POST",
                data: $(this).serialize(),
