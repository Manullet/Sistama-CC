<?php 
session_start();
 $_SESSION['url'] = 'vistas/tbl_sector.php';
...
<div class="containertable">
    <div class="d-flex justify-content-between align-items-end mb-4">
        <div>
            <h1 class="poppins-font mb-2">SECTOR</h1>
            <br>
    ...
    <div class="table-responsive">
        ...
        <table class="table table-hover">
            ...
            <tbody class="text-center">
                ...
                $sql = $conexion->query("SELECT * FROM tbl_sector");
                while ($datos = $sql->fetch_object()) { ?>
                    <tr>
                        ...
                        <td>
                            ...
                            ('<?= $datos->id_sector ?>', '<?= $datos->sector ?>', '<?= $datos->descripcion ?>', '<?= $datos->creado_por ?>', '<?= $datos->fecha_creacion ?>', '<?= $datos->actualizado_por ?>', '<?= $datos->fecha_actualizacion ?>', '<?= $datos->estado ?>' )">
