<?php 
session_start();
 $_SESSION['url'] = 'vistas/tbl_categoria_especies.php';
...
<div class="containertable">
    <div class="d-flex justify-content-between align-items-end mb-4">
        <div>
            <h1 class="poppins-font mb-2">Categoría Especie</h1>
            <br>
    ...
    <div class="table-responsive">
        ...
        <table class="table table-hover">
            ...
            <tbody class="text-center">
                ...
                $sql = $conexion->query("SELECT tbl_sector.sector, tbl_categorias_especies.id_categoria_especie, tbl_categorias_especies.categoria_especie, tbl_categorias_especies.descripcion, tbl_categorias_especies.creado_por, tbl_categorias_especies.fecha_creacion, tbl_categorias_especies.actualizado_por, tbl_categorias_especies.fecha_actualizacion, tbl_categorias_especies.estado FROM tbl_categorias_especies INNER JOIN tbl_sector ON tbl_categorias_especies.id_sector = tbl_sector.id_sector");
                while ($datos = $sql->fetch_object()) { ?>
                    <tr>
                        ...
                        <td>
                            ...
                            ('<?= $datos->sector ?>', '<?= $datos->id_categoria_especie ?>', '<?= $datos->categoria_especie ?>', '<?= $datos->descripcion ?>', '<?= $datos->creado_por ?>', '<?= $datos->fecha_creacion ?>', '<?= $datos->actualizado_por ?>', '<?= $datos->fecha_actualizacion ?>', '<?= $datos->estado ?>' )">
                                <i class="bi bi-pencil-square"></i>
                                Editar
                            </button>
                            <form id="deleteForm" method="POST" action="modelos/delete_CategoriaEspecie.php" style="display: inline;">
                                <input type="hidden" name="id_categoria_especie" value="<?= $datos->id_categoria_especie ?>">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="formularioEditar" method="POST" action="modelos/update_CategoriaEspecie.php">
                    <div class="row">
                        <div class="col-6">
        ...
        ?>
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="id_categoria_especie" name="id_categoria_especie" readonly>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                <label for="categoria_especie">Categoría Especie</label>
                                <input type="text" class="form-control" id="categoria_especie_edit" name="categoria_especie" required>
                            </div>
                        </div>
                    </div>
                    <div class="col-8">
...
<div class="modal fade" id="modalForm" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content" role="document">
            <div class="modal-header" style="background-color: #17A2B8;">
                <h5 class="poppins-modal mb-2" id="exampleModalLabel">CREAR CATEGORIA ESPECIE</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Cerrar">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="modelos/insert_CategoriaEspecie.php" method="POST">
                    <div class="row">
                        <div class="col-8">
        ...
        ?>
                        ...
                        <div class="col-8">
                            <label for="categoria_especie" class="form-label">Categoría Especie</label>
                            <input type="text" class="form-control" id="categoria_especie" name="categoria_especie">
                        </div>
                        <div class="col-8">
                     <label for="descripcion" class="form-label">Descripción</label>
...
<script>
    ...
    function abrirModalEditar(id_categoria_especie, categoria_especie ,descripcion, creado_por, fecha_creacion, actualizado_por, fecha_actualizacion, estado) {
        document.getElementById("id_categoria_especie").value = id_categoria_especie;
        document.getElementById("categoria_especie_edit").value = categoria_especie;
...
<script>
    $(document).ready(function() {
        $("#formularioEditar").on("submit", function(event) {
            ...
            $.ajax({
                url: "modelos/update_CategoriaEspecie.php",
                method: "POST",
                data: $(this).serialize(),
