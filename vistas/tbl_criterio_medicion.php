...
<link rel="stylesheet" href="assets/css/tbl_criterio_medicion.css">
...
<div class="containertable">
    <div class="d-flex justify-content-between align-items-end mb-4">
        <div >
            ...
            <i class="bi bi-plus-square icono-grande"></i> Agregar Criterio de Medición
            </a>
        </div>
        <br>
        ...
        <table  class="table table-bordered">
            <thead class="text-center" style="background-color: #AED4F3;">
                <tr>
                    ...
                    <th scope="col">Id_Criterios_Medición</th>
            ...
            <tbody class="text-center">
                ...
                $sql = $conexion->query("SELECT * FROM tbl_criterio_medicion");
