                ...
                while ($datos = $sql->fetch_object()) { ?>
                    <tr>
                        ...
                        <td>
                            ...
                            ('<?= $datos->id_cultivo ?>', '<?= $datos->cultivo ?>', '<?= $datos->descripcion  ?>', '<?= $datos->modificado_por ?>', '<?= $datos->ficha ?>', '<?= $datos->sector ?>', '<?= $datos->estado ?>')">
                                <i class="bi bi-pencil-square"></i>
                                Editar
                            </button>
                            <form id="deleteForm" method="POST" action="modelos2/delete_categoria_cultivo.php" style="display: inline;">
...
<script>
    ...
    function abrirModalEditar(id_cultivo, cultivo, descripcion, modificado_por, estado, id_ficha, id_sector) {
