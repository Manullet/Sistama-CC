...
<link rel="stylesheet" href="assets/css/tbl_fermentacion_estiercol.css">
...
<div class="containertable">
    <div class="d-flex justify-content-between align-items-end mb-4">
        <div >
            <h1 class="poppins-font mb-2">FERMENTACION ESTIERCOL</h1>
            <br>
        ...
        <table  class="table table-bordered">
            <thead class="text-center" style="background-color: #AED4F3;">
                <tr>
                    ...
                    <th scope="col">Id_Categoria_Ficha</th>
                    <th scope="col">Nivel Medicion</th>
                    <th scope="col">Id_Fermentacion</th>
                    <th scope="col">Id_Sector</th>
                    <th scope="col">Año</th>
                    <th scope="col">Numero</th>
                    <th scope="col">Id_Categoria_Especie</th>
                    <th scope="col">Id_Especie</th>
                    <th scope="col">Categoria Medicion</th>
                    <th scope="col">Id_Criterios Medicion</th>
            ...
            <tbody class="text-center">
                ...
                $sql = $conexion->query("SELECT * FROM tbl_fermentacion_estiercol");
