...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["id_categoria_ficha"])) {
    $id_categoria_ficha = $_POST["id_categoria_ficha"];

    $delete_query = "DELETE FROM tbl_categorias_fichas WHERE id_categoria_ficha = '$id_categoria_ficha'";
