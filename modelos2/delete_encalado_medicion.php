...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["id_encalado_medicion"])) {
    $id_encalado_medicion = $_POST["id_encalado_medicion"];

    $delete_query = "DELETE FROM tbl_encalado_medicion_n WHERE id_encalado_medicion = '$id_encalado_medicion'";
