...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  //  $Fecha_Actualizacion = date("Y-m-d H:i:s");
    ...
    $sql = "CALL Update_FPRP('$id_gestion_estiercol_FPRP', '$id_sector', '$id_categoria_especie', '$id_especie', '$gestion_estiercol_FPRP',  '$sigla',  '$descripcion' ,'$actualizado_por','$estado')";
