...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["id_fprp_estiercol_medicion"])) {
    $id_fprp_estiercol_medicion = $_POST["id_fprp_estiercol_medicion"];

    $delete_query = "DELETE FROM tbl_estiercol_fprp_medicion WHERE id_fprp_estiercol_medicion = '$id_fprp_estiercol_medicion'";
